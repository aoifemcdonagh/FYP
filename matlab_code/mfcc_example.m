...
%   Author: Kamil Wojcicki, September 2011
    ...
    wav_file = 'U:\My Documents\4th Year\FYP\Irish Language\Files for analysis\Connacht_1.wav';  % input audio filename

    % implement for loop to analyse successive segments of the audio file
    segment_size = 50000;
    for i=1:segment_size:500000
        
        % Read speech samples, sampling rate and precision from file
        [ speech, fs ] = audioread( wav_file , [i i+segment_size]);
